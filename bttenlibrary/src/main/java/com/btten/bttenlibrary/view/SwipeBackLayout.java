...
public class SwipeBackLayout extends FrameLayout
{
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev)
    {
        ...
        Log.i(TAG, "mViewPager = " + mViewPager + " , mViewPagers.size:" + mViewPagers.size());
...
//            return super.onInterceptTouchEvent(ev);
    ...
    /**
     * 如果界面中Fragment的多个Fragment中都存在ViewPager，当Fragment在切换的时候，调用该方法，清除原有的ViewPager集合，重新加载
     */
...
//            v.getHitRect(mRect);
            ...
            Rect mRect = new Rect(location[0], location[1], location[0] + v.getWidth(), location[1] + v.getHeight());
