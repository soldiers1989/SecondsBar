...
public class ToggleButton extends View
{
    ...
    public void setup(AttributeSet attrs)
    {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, ResourceHelper
                .getInstance(BtApplication.getApplication().getApplicationContext()).getStyleableIds("ToggleButton"));
        offBorderColor = typedArray
                .getColor(ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
                        .getStyleableId("ToggleButton_offBorderColor"), offBorderColor);
        onColor = typedArray.getColor(ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
                .getStyleableId("ToggleButton_onColor"), onColor);
        spotColor = typedArray
                .getColor(ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
                        .getStyleableId("ToggleButton_spotColor"), spotColor);
        offColor = typedArray
                .getColor(ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
                        .getStyleableId("ToggleButton_offColor"), offColor);
        borderWidth = typedArray.getDimensionPixelSize(
                ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
                        .getStyleableId("ToggleButton_borderWidth"),
                borderWidth);
        defaultAnimate = typedArray
                .getBoolean(ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
                        .getStyleableId("ToggleButton_animate"), defaultAnimate);
        typedArray.recycle();
