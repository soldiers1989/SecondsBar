	...
	private void setCustomAttributes(AttributeSet attrs) {
		TypedArray a = mContext.obtainStyledAttributes(attrs,
				ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
						.getStyleableIds("roundedimageview"));
		mBorderThickness = a.getDimensionPixelSize(
				ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
						.getStyleableId("roundedimageview_border_thickness"),
				0);
		mBorderOutsideColor = a
				.getColor(ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
						.getStyleableId("roundedimageview_border_outside_color"), defaultColor);
		mBorderInsideColor = a
				.getColor(ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
						.getStyleableId("roundedimageview_border_inside_color"), defaultColor);
		a.recycle();
	}
