package com.btten.bttenlibrary.view.wheelview;
...
public class WheelView extends View {
	...
	// Color.parseColor("#0F000000"), Color.parseColor("#0F000000"),
	// Color.parseColor("#0F000000") };
	private static final int[] SHADOWS_COLORS = new int[] { Color.parseColor("#0F000000"), 0x00AAAAAA, 0x00AAAAAA };
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(ResourceHelper
					.getInstance(BtApplication.getApplication().getApplicationContext()).getDrawableId("wheel_val"));
		}
		...
		setBackgroundResource(ResourceHelper.getInstance(BtApplication.getApplication().getApplicationContext())
				.getDrawableId("wheel_bg"));
	}
