...
public class GlideCacheUtil
{
    ...
    public String getCacheSize()
    {
        try
        {
            return getFormatSize(getFolderSize(Glide.getPhotoCacheDir(BtApplication.getApplication())));
        } catch (Exception e)
        {
            e.printStackTrace();
            return "0.00M";
    ...
    {
        return deleteFolderFile(Glide.getPhotoCacheDir(BtApplication.getApplication()).getAbsolutePath(), true);
    }
    ...
    public boolean clearCacheDiskSelf()
    {
        try
        {
            Glide.get(BtApplication.getApplication()).clearDiskCache();
            return true;
        } catch (Exception e)
        {
            e.printStackTrace();
    ...
    public boolean clearCacheMemory()
    {
        try
        {
            ...
            { //只能在主线程执行
                Glide.get(BtApplication.getApplication()).clearMemory();
                return true;
            }
        } catch (Exception e)
        {
